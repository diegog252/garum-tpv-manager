...
echo.
echo  ============================================================
echo   GARUM TPV Manager v7.4 - Instalador para Windows 64 bits
echo  ============================================================
echo.
...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
 "$ws=New-Object -ComObject WScript.Shell; $s=$ws.CreateShortcut([Environment]::GetFolderPath('CommonDesktopDirectory')+'\GARUM TPV Manager.lnk'); $s.TargetPath='!INST!\ARRANCAR.bat'; $s.WorkingDirectory='!INST!'; $s.Description='GARUM TPV Manager v7.4'; $s.Save()"
